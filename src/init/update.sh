...
getPreinstalledDirByType()
{
    echo "########### JNote : running on update.sh : getPreinstalledDirByType() ###########"
...
isWazuhInstalled()
{
    echo "########### JNote : running on update.sh : isWazuhInstalled() ###########"
...
getPreinstalledDir()
{
    echo "########### JNote : running on update.sh : getPreinstalledDir() ###########"
...
getPreinstalledType()
{
    echo "########### JNote : running on update.sh : getPreinstalledType() ###########"
...
# ************ Line:344-365 ************ 執行wazuh服務的地方
UpdateStartOSSEC()
{
    echo "########### JNote : running on update.sh : UpdateStartOSSEC() ###########"
